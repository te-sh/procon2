// URL: https://atcoder.jp/contests/arc047/tasks/arc047_c
...
void main()
{
  ...
  foreach (i; 1..n+1) ++ft[i];
  auto bs = iota(1, n+1).map!(i => tuple(i, ft[0..i])).assumeSorted!"a[1]<b[1]";

  foreach_reverse (fi; f[0..n]) {
    auto e = bs.equalRange(tuple(0, fi)).back[0];
    writeln(e);
    --ft[e];
  }
}
