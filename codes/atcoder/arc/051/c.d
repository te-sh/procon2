// URL: https://beta.atcoder.jp/contests/arc051/tasks/arc051_c
...
void main()
{
  ...
  auto m = new mint[](n);
  foreach (i; 0..n)
    m[i] = mint(c[i])*mint(a).repeatedSquare(b/n);

  foreach (i; b%n..n) writeln(m[i]);
  foreach (i; 0..b%n) writeln(m[i]*a);
}
